...
public class ApplauseDslFactoryImpl extends EFactoryImpl implements ApplauseDslFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case ApplauseDslPackage.BUTTON: return createButton();
      ...
      case ApplauseDslPackage.WEB_VIEW: return createWebView();
   ...
   * @generated
   */
  public ApplauseModel createApplauseModel()
  {
    ApplauseModelImpl applauseModel = new ApplauseModelImpl();
